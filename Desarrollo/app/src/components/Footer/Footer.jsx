  ...
  return (
    <footer className="footer">
      ...
      <div className="contenedor2">
        <a rel="noreferrer" href="https://www.facebook.com/profile.php?id=100083181944289" target="_blank"><span className="nombre-red-social">Facebook: FISI </span><img className="red-social" src="public/Facebook.png" alt="Facebook FISI" /></a>
      </div>
